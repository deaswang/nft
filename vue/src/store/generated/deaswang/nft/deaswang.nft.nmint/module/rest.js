...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryMinterAll = (query, params = {}) => this.request({
         ...
         */
        this.queryMinter = (index, params = {}) => this.request({
         ...
         */
        this.queryMinterwlAll = (query, params = {}) => this.request({
         ...
         */
        this.queryMinterwl = (collectionId, params = {}) => this.request({
