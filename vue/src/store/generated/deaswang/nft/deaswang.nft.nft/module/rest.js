...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryNftAll = (collectionId, query, params = {}) => this.request({
         ...
         */
        this.queryNft = (collectionId, tokenId, params = {}) => this.request({
         ...
         */
        this.queryOwnerAll = (index, query, params = {}) => this.request({
         ...
         */
        this.queryOwner = (index, collectionId, params = {}) => this.request({
