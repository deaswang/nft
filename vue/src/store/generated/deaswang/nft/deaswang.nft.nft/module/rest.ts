...
export type NftMsgApproveAllResponse = object;

export type NftMsgApproveResponse = object;

export type NftMsgCollectionInitResponse = object;

export type NftMsgTransferFromResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryCollectionAll = (
    ...
    this.request<NftQueryAllCollectionResponse, RpcStatus>({
      path: `/deaswang/nft/nft/collection`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryCollection = (index: string, params: RequestParams = {}) =>
    this.request<NftQueryGetCollectionResponse, RpcStatus>({
      path: `/deaswang/nft/nft/collection/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryNftAll = (
    ...
    this.request<NftQueryAllNftResponse, RpcStatus>({
      path: `/deaswang/nft/nft/nft/${collectionId}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryNft = (collectionId: string, tokenId: string, params: RequestParams = {}) =>
    this.request<NftQueryGetNftResponse, RpcStatus>({
      path: `/deaswang/nft/nft/nft/${collectionId}/${tokenId}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryOwnerAll = (
    ...
    this.request<NftQueryAllOwnerResponse, RpcStatus>({
      path: `/deaswang/nft/nft/owner/${index}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryOwner = (index: string, collectionId: string, params: RequestParams = {}) =>
    this.request<NftQueryGetOwnerResponse, RpcStatus>({
      path: `/deaswang/nft/nft/owner/${index}/${collectionId}`,
      method: "GET",
      format: "json",
      ...params,
    });
